...
const Header: React.FC = () => {
    ...
    return (
        <header className="bg-black  px-4 sm:px-6 lg:px-8 text-white fixed w-full z-50 shadow-lg">
            <div className=" flex justify-between items-center h-16">
                ...
                <div className="hidden md:flex">
                    <Link
                        href="/contact"
                        className=" text-white border-[1px] border-gray-400 px-4 py-2 rounded-full hover:bg-gray-200 hover:text-gray-700 transition"
                    >
                        Let's Talk
                    </Link>
                </div>
